...
V3'te Markdown kaynak, SQLite yerel indeks, Codex/Claude Code/Antigravity ise aynı motora bağlanan istemcilerdir. Python 3.11+ dışında ek Python paketi gerekmez. Varsayılan akışta Mem0, API anahtarı, daemon veya ayrı sunucu kurulmaz. Açık komutla kullanılan [Jev danışmanı](JEV.md) isteğe bağlıdır; normal arama ve hook akışını değiştirmez.
...
[V3.0.2 release](https://github.com/avenoxai/avenoxbeyin/releases/tag/v3.0.2) ve `beyin-v3-3.0.2.zip` paketi stable dağıtım noktasıdır. Son yerel turda 139 test ile 10/10 development ve 6/6 holdout semantik senaryosu; CI'da native Windows işleri geçti.
