...
V3'te Markdown kaynak, SQLite yerel indeks, Codex/Claude Code/Antigravity, [Hermes Agent](HERMES.md) ve [OpenCode](OPENCODE.md) ise aynı motora bağlanan istemcilerdir. Python 3.11+ dışında ek Python paketi gerekmez. Mem0, API anahtarı, daemon veya ayrı sunucu kurulmaz.
