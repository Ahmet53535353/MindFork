...
2. İşletim sistemini ve çalışan Python'u doğrula: macOS/Linux `python3`, Windows `py -3` veya çalışan `python`. Python 3.11+ gerekir. Yorumlayıcı yoksa eksik gereksinimi açıkça söyle; kuruluymuş gibi devam etme.
